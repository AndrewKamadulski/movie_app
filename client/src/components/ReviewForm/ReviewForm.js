...
export const ReviewForm = (props) => {
    ...
    const handleFormSubmit = async (event) => {
        ...
        try {
            ...
            const validateMovie = await fetch(`http://www.localhost:8080/api/movies/${movieObj.id}`);
            if (!validateMovie.ok) {
    ...
    return (_jsxs("div", { className: 'my-3', children: [_jsxs("p", { className: `m-1 ${characterCount === 280 || error ? 'text-error' : ''}`, children: ["Character Count: ", characterCount, "/280", error && _jsx("span", { className: "ml-2", children: "Something went wrong..." })] }), _jsxs("form", { className: "flex-row justify-center justify-space-between-md align-stretch d-lg-flex", onSubmit: handleFormSubmit, children: [_jsx("textarea", { placeholder: "Leave a Comment...", value: Text, className: "form-input col-12 col-md-9 m-1", onChange: handleChange }), _jsx("div", { className: 'my-1 mx-2', children: _jsx("button", { className: "btn submit-btn bg-red text-light w-100", type: "submit", children: "Submit" }) })] })] }));
};
